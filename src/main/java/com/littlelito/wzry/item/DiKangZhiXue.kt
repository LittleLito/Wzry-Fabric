...
class DiKangZhiXue(
    private val material: WzryArmorMaterial = WzryArmorMaterials().DIKANGZHIXUE,
    ...
    override fun appendTooltip(
        ...
        tooltip.add(TranslatableText("item.wzry.dikangzhixue.tooltip.description").formatted(Formatting.ITALIC, Formatting.GRAY))
    }
}